...
<script>
	...
	var goConfigurar = function(codigo) {
		if ($$("idplantilla").value == 1){		
		  location.href = "nuevo_configuracionPage.php?pagina="+codigo;	
		}
		if ($$("idplantilla").value == 2){
		   location.href = "nuevo_configuracionPages.php?pagina="+codigo;		
		}
		if ($$("idplantilla").value == 3){
		   location.href = "nuevo_configuracionPaginas.php?pagina="+codigo;		
		}
	}
