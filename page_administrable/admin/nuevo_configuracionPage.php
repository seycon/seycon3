<?php
    ...
    if (isset($_POST['transaccion'])) {  
		...
		'titulo secundario','$_POST[Ctitulos]',$_SESSION[IDpagina])";
		...
		('titulo contenido lateral','$_POST[Otitulo3]',$_SESSION[IDpagina])";
	   ...
	   //imagenes Cabecera
	   $hora = time();	   
	   $nombre = $_FILES['Clogo']['name'];
	   if ($nombre != "" ) {
	       copy($_FILES['Clogo']['tmp_name'],"../file/$hora$nombre");		   
		   $sql[$numConsulta + 1] = "delete from contenido where session='imagen logo' and idpagina=$_SESSION[IDpagina];";
		   $sql[$numConsulta + 2] = "insert into contenido(session,contem,idpagina) values
		   ('imagen logo','file/$hora$nombre',$_SESSION[IDpagina])";
	   ...
	   if ($nombre != "" ) {
        ...
        header("Location: nuevo_configuracionPage.php?estadoT=v");
    }   
...
<div class="contem2">
   ...
   <form id="formulario" name="formulario" method="post" action="nuevo_configuracionPage.php" enctype="multipart/form-data">   
   ...
   <div class="boton2M"><input type="reset" class="boton" value="Cancelar"/></div>
	 ...
	 ?>
        ...
        <tr>
          <td>&nbsp;</td>
          <td align="right" class="textoSubContem">Logo:</td>
          <td><input type="file" name="Clogo" id="Clogo" class="file_1" /></td>
     ...
     <table width="100%" border="0" align="center">
        ...
        <tr>
          <td>&nbsp;</td>
          <td align="right" class="textoSubContem">Titulo:</td>
          <td colspan="2"><input type="text" name="Otitulo3" id="Otitulo3" class="field" value="<?php echo $tcl['contem'];?>"/></td>
          <td>&nbsp;</td>
        </tr>
        <tr>
          <td>&nbsp;</td>
