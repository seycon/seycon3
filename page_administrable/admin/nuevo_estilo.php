...
<div class="contem">
  ...
  <tr>
	...
	if ($_SESSION['IDplantilla'] == 2) {
	 $vector = array("Madera","Plomo","Negro y Blanco");
 	 $ids = array("sPage2_1.css","sPage2_2.css","sPage2_3.css");
	 $i = 0;
	 foreach($vector as $valor) {
		$atributo = "";
		if ($ids[$i] == $datosG['estilo']) { 
	...
	if ($_SESSION['IDplantilla'] == 3) {
	 $vector = array("Negro y Cafe Claro","Plomo","Madera");
 	 $ids = array("sPage3_1.css","sPage3_2.css","sPage3_3.css");
	 $i = 0;
	 foreach($vector as $valor) {
		$atributo = "";
		if ($ids[$i] == $datosG['estilo']) { 
