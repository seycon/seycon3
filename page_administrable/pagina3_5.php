<?php 
	...
	$db = new MySQL();
    $sql = "select * from pagina where idplantilla=3 and numero=5;";  
...
<link rel="stylesheet" type="text/css" href="css/sPage3_1.css" />
...
<div class="contemData">
  ...
  <div class="contemDataConten"><p><img src="images/img5.jpg" style="float:left;margin:5px 15px 8px 0;" align="left"/>
