...
<?php
	...
	$fileAcceso = $db->privilegiosFile($estructura['Activo'],'Tipos de Activos','listar_tipoactivo.php','nuevo_tipoactivo.php');
...
function eliminarTransaccion(){
  location.href = "anular_registro.php?idtipoactivo="+$$("idDelete").value+"&tabla=tipoactivo&menu=4";
}
...
var openMensaje = function(codigo){
	...
	$$("modal_contenido").innerHTML = '¿Desea anular este Tipo de Activo?';
...
<form name="listado" id="listado" method='get' action='listar_tipoactivo.php#t4' enctype='multipart/form-data'>
      ...
      <div class="listadoCombo1">
          <div class="borde1Listar"> </div>
            <select id="campo" name="campo" class="borde2Combo1">
              <?php
				echo "<option value=idtipoactivo>Nº</option>";
...
<?php
	...
	$sql = "SELECT idtipoactivo,left(nombre,25),tiempouso from tipoactivo ".$condicion." order by idtipoactivo desc";
...
<?php
	$nombres = array(  "Nº", "Nombre", "Tiempo de Uso");
...
if ($fileAcceso['Modificar'] == "Si"){ 
	 echo "<td><div align='center'><a href='nuevo_tipoactivo.php?idtipoactivo=".$id."&sw=1#t4' onclick='return modificar(this)'> <img src='css/images/edit.gif' title='Modificar' alt='editar' border='0' /><br /></a></div></td>";
	}else{
