...
if (!$db->tieneAccesoFile($estructura['Agenda'],'Reporte Financiero','nuevo_balancegeneral.php')){
...
<link rel="stylesheet" href="balance/balance.css" type="text/css"/>
<script src="balance/balance.js"></script>
...
<td colspan='5' align='center' >
  ...
  <tr class='cabeceraInicialListar'> 
    ...
    <table width="100%" border="0"  align="center">
      ...
      <tr>
        <td width="19%" align="center"><input type='text' id="desde" name="desde" 
        value="<?php 
		  $fecha = explode("/", date("d/m/Y"));
		  $fechaInicial = "01/".$fecha[1]."/".$fecha[2];
		  echo $fechaInicial;
        ?>"
        class="date" size="10" /></td>
        <td width="24%" align="center"><input type='text' id="hasta" name="hasta" 
...
?>"
 class="date" size="10" /></td>
        <td width="18%" align="center"><input type="checkbox" name="auxiliares2" id="auxiliares2" onchange="mostrarAuxiliares()" style="display:block" checked="checked"/></td>
        <td width="13%" align="center"><input type="checkbox" name="logo" id="logo" onchange="mostrarAuxiliares()" style="display:block" checked="checked"/></td>
        <td width="25%" align="center"><select name="moneda" id="moneda" onchange="limpiarDetalle();" style="width:100px;background:#FFF;border:solid 1px #999;">
          <?php          
...
<tr>
  ...
  <td width='156' align="right" valign='top'>Fecha<span class='rojo'></span>:
  <input type='text' id="fecha" name="fecha" value="<?php if (isset($datoNota['idnota']))
  echo $db->GetFormatofecha($datoNota['fecha'],'-');
  else
  echo date("d/m/Y");
  ?>"
 class="date" size="10" />
  ...
  <td width='166'  align='right' valign='top'>Ocultar Auxiliares:</td>
  <td width='103' valign='top'><input type="checkbox" name="auxiliares" id="auxiliares" onchange="mostrarAuxiliares()" style="display:block" checked="checked"/></td>
