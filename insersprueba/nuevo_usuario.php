<?php
    ...
    if (isset($_POST['transaccion'])) {		
        ...
        if ($_POST['transaccion'] == "insertar") {
		    $sql = "INSERT INTO usuariorestaurante(idusuario,idtrabajador,tipo,login,clave,estado,idsucursal,turno)"
	        ...
	        $sql = "update usuariorestaurante set idtrabajador='$_POST[idpersonarecibida]',clave='".filtro($claveFinal)
	            ."',tipo='".filtro($_POST['tipo'])."',login='".filtro($_POST['usuario'])
				."',idsucursal='".filtro($_POST['sucursal'])."',turno='".filtro($_POST['turno'])
				."' where idusuario='$_POST[identificador]'";	  	
        }
        $db->consulta($sql);
...
<body>
 <div class="contendedor">
  ...
  <tr>
    ...
    <td width="5%">&nbsp;</td>
    <td width="59%">&nbsp;</td>
    <td width="15%"><input type="button" value="Guardar"  class="botonrestaurante" onclick="getValidacionUsuario()" id="botonUsuario"/></td>
  ...
  <tr>
    ...
    <td><select name="tipo" id="tipo" onchange="getPersonal(this.value)">
  ...
  <tr>
    ...
    <td><input type="text" name="usuario" id="usuario" class="required"  value="<?php echo $datosG['login'];?>"/>
  ...
  <tr>
    ...
    <td><input type="password" name="clave" id="clave" class="required" minlength="6" value=""/>
