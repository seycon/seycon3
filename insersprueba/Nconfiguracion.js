// JavaScript Document
 ...
 var efectoClick = function(id){
	var ides = ['chonorario','cparametros','cventa','cprecio','cturno','cdescuento']; 
...
function ajaxx() {
 ...
 function ejecutarTransaccion(){
	...
	var cadena = "transaccion=insertar&guardiam1="+$$("guardiam1").value+"&guardiam2="+$$("guardiam2").value+"&guardiam3="+$$("guardiam2").value
