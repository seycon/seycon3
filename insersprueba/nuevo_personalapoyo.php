    ...
    if (isset($_POST['transaccion'])) {
	    ...
	    if($_POST['transaccion'] == "insertar"){
	        ...
	        $sql = "INSERT INTO personalapoyo(idpersonalapoyo,nombre,apellido,ci,fechaingreso,cargo"
	            .",diastrabajo,honorario,comision,diassemana,estado) VALUES" 
            ...
            $sql = "update personalapoyo set nombre='".filtro($_POST['nombre'])."',apellido='".filtro($_POST['apellido'])
                ...
                ."',comision='".filtro($_POST['comision'])."',diassemana='$dias'" 
...
<body>
 <div class="contendedor">
  ...
  <tr>
    <td></td>
    <td align="right">Ci:<span class="rojo">*</span></td>
    <td align="left"><input type="text" class="required" name="ci" id="ci" value="<?php echo $datosG['ci'];?>"/></td>
    <td align="right">Fecha Ingreso:</td>
    <td><input type="text" name="fechaingreso" size="10" id="fechaingreso" class="date" value="<?php if (isset($datosG['fechaingreso'])) 
