...
<div id="modal_mensajes" class="modal_mensajes">
  ...
  <div class="modal_boton2"><input type="button" value="Aceptar" class="boton_modal" onclick="setPedidoAnulado()"/></div>
 ...
 <div class="contendedor">
  ...
  <tr>
    ...
    <div class="contenedorMenu">
     <div id="opcion1" onclick="location.href='nuevo_atencion.php'"><div id="textoOpcion">Inicio</div></div>
     <div class="separador"></div>
     <div class="contenedorProductos">
      <div class="cabeceraProductos"><div class="textocabeceraProductos">Menú</div>  </div>
      <div class="ingresarProducto">
      <table width="100%" border="0">
  <tr>
    <td class="textoIngresoProducto">Buscar:</td>
    <td><input type="text" name="producto" id="producto" style="width:80%" onkeyup="consultarProductos(this.value)" autocomplete="off"/></td>
  </tr>
</table>
      ...
      <div class="listaProductos">
       <ul id="productos">
         <?php		   
		     $sql = "select idcombinacion,left(nombre,17) as 'nombre1',total as 'precio',nombre from combinacion
		     where nombre like '%' and estado=1 limit 9;";
	         $producto = $db->consulta($sql);
	         while ($dato = mysql_fetch_array($producto)) {
		         $item = "<li onclick='openVentanaPedido(&quot;$dato[nombre]&quot;,&quot;$dato[precio]&quot;,&quot;"
				     ."$dato[idcombinacion]&quot;)'>".ucfirst($dato['nombre1'])."</li>";		  
				 echo $item;	 
			 }
		 ?>
       </ul>
  ...
  <tr >
    <td width="4%" ></td>
    <td width="9%" class="celdacuadernoCabecera" >Nº</td>
  ...
  <tr>
    <td><table width="100%" border="0">
      <tr>
        ...
        <td width="16%"><input type="text" value="Imprimir" id="botonrestaurante" onclick="getReporte1()"/></td>
 ...
 <div class="headerInterior"><div class="tituloVentanaclave">Cobranza de Mesa</div></div>  
  ...
  <tr>
    ...
    <td width="39%">        
        <input type="text"  id="dato" autocomplete="off" onkeyup="autocompletar(event,this.id)" onfocus="this.select()" style="width:100px;"/><br>
        <div  id="resultados"  class="divresultado" ></div>
        <input type="hidden" id="codidproducto" />
        
        </td>
    <td width="27%" class="textoClave" align="right">Credito
      <input type="checkbox" id="credito" name="credito" onclick="limpiarIngreso()"/></td>
    
  </tr>
  <tr>
    <td width="6%">&nbsp;</td>
    <td width="28%" align="right" class="textoClave">Total Venta:</td>
    <td><input type="text" name="totalgeneral" id="totalgeneral" size="13" disabled="disabled"/></td>
  ...
  <tr>
    <td>&nbsp;</td>
    <td align="right" class="textoClave">Descuento:</td>
    <td colspan="2"><input type="text" name="descuento" id="descuento" disabled="disabled" size="13" value="0"/></td>
    <td>&nbsp;</td>
  </tr>
  <tr >
    <td >&nbsp;</td>
  ...
  <tr>
    <td>&nbsp;</td>
    <td class="textoClave" align="right">Efectivo bs:</td>
    <td colspan="2">
    <input type="text" name="efectivobs" id="efectivobs" size="13" onkeyup="getCambio()" value="0"/>
    </td>
    <td>&nbsp;</td>
  </tr>
  <tr>
 ...
 <div class="posicionCloseSub" onclick="closeVentanaPedido();"><img src="../iconos/borrar2.gif" width="12" height="12"></div>
  ...
  <tr>
    ...
    <td><input type="text" name="cantidadproducto" id="cantidadproducto" size="13"/></td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    <td>&nbsp;</td>
