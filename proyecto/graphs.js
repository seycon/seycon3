...
function createGraph(valor) {
   ...
   if (valor<=100){   
	...
	openMensaje("Advertencia","Porcentaje fuera de Rango"); 
	porcentaje = "100,0";
	document.getElementById("avanceP").value="";
   }
          var graph = new BAR_GRAPH("vBar");
		 graph.values = porcentaje;
		 graph.labels = "NO,SI";
		 graph.showValues = 1;
		 graph.barWidth = 60;
		 graph.barLength = 1.5;
		 ...
		 graph.graphBGColor = "#000";
		 graph.graphBorder = "1px solid blue";
		 graph.barColors = "#2E728E";
		 graph.barBGColor = "#FFF";
		 graph.barBorder = "2px outset white";
		 graph.labelColor = "#FFF";
		 graph.labelBGColor = "#2E728E";
		 ...
		 document.getElementById('graficaD').innerHTML = graph.create(); 
}



function graficar(valor,resultado) {
   var val = valor;
   var val2 = 100 - val;
   ...
   if (valor <= 100){   
	...
	porcentaje = "100,0";
		 ...
		 graph.graphBorder = "1px solid #000";
		 ...
		 graph.absValuesBGColor = "#FFFFFF";
		 graph.absValuesBorder = "2px groove white";	  
		 document.getElementById(resultado).innerHTML = graph.create(); 
}
