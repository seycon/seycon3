...
<?php
	 ...
	 if (!$db->tieneAccesoFile($estructura['Inventario'],'Traspaso de Productos','nuevo_reportetraspasoproducto.php')){
...
var viewreporte_prodcuto = function(){
  window.open('traspaso_almacen/reporte_traspaso_general.php?desde='+$$('fecha').value+'&hasta='+$$("fecha2").value+'&moneda='+$$("moneda").value+'&idsucursal='+$$("sucursal").value,'target:_blank');
}


var viewreporte_productoDetallado = function(){
  window.open('traspaso_almacen/reporte_traspaso_detallado.php?desde='+$$('fecha3').value+'&hasta='+$$("fecha4").value+'&moneda='+$$("moneda2").value+'&idsucursal='+$$("sucursal2").value,'target:_blank');	
}
...
<table cellpadding='0' cellspacing='0' width='99%' align="center" class="contemHeaderTop">
  <tr class='cabeceraInicialListar'> 
    <td height="92" colspan='2' valign="middle">&nbsp;&nbsp; <div class="titleFromReport">
     Reporte Traspaso de Productos</div>
    </td>
<td></td>
<td colspan="3" align='right'>
 ...
 <div id="datos_factura" class="datos_cliente1">
  <table width="100%" border="0">
      ...
      <tr>
        ...
        <div class="menuopcionesreporte">
          <div class="botonreporte" id="r1" onclick="viewOptionReporte('r1')"> Traspaso General</div>
          <div class="espacioreporte"></div>
          <div class="botonreporte2" id="r2" onclick="viewOptionReporte('r2')">Traspaso Detallado</div>
  ...
  <tr>
    ...
    <td><input name="fecha3" type="text" id="fecha" value="<?php echo date("d/m/Y"); ?>" size="9"  /></td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    ...
    <td><input name="fecha4" type="text" id="fecha2" value="<?php  echo date("d/m/Y"); ?>" size="9"  /></td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    ...
    <td>
    <select id="moneda" name="moneda" style="width:150px;background:#FFF;border:solid 1px #999;" >
  ...
  <tr>
    ...
    <td><select id="sucursal" name="sucursal" style="width:150px;background:#FFF;border:solid 1px #999;" >
      <option value="*">-- Todos--</option>
      <?php
			$sql='select s.* from sucursal s inner join almacen a on s.idsucursal=a.sucursal
                         inner join traspaso t on t.idalmacenorigen=a.idalmacen
                            where s.estado=1 and a.estado=1 and t.estado=1
  ...
  <tr>
    ...
    <td align="right">Moneda:</td>
    <td>
    <select id="moneda2" name="moneda2" style="width:150px;background:#FFF;border:solid 1px #999;" >
      <option value="Bolivianos">Bolivianos</option>
      <option value="Dólares">Dólares</option>
    </select></td>
    <td>&nbsp;</td>
  ...
  <tr>
    <td>&nbsp;</td>
    <td align="right">Sucursal:</td>
    <td><select id="sucursal2" name="sucursal2" style="width:150px;background:#FFF;border:solid 1px #999;" >
      <option value="*">-- Todos--</option>
      <?php
			$sql='select s.* from sucursal s inner join almacen a on s.idsucursal=a.sucursal
			 inner join traspaso t on t.idalmacenorigen=a.idalmacen
  ...
  <tr>
    ...
    <td>&nbsp;</td>
    <td colspan="2"><input type="button" name="aceptar" id="aceptar" value="Realizar Reporte"
     onclick="viewreporte_productoDetallado();"  class="botonNegro" style="width:110px;"/></td>
    </tr>
  <tr>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
