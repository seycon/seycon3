                    ...
                    <?php 
						...
						while( $fila = mysql_fetch_row($res)){
							...
							echo '<tr '.$clase.'>
								  ...
								  <td>'.$fila[3].'</td>
								  <td>'.$fila[1].'</td>
								  <td><a href="registrar_pagina.php?idpagina='.$fila[0].'"><img src="assets/action_add.png" alt="Add" /></a><a href="pagina/Dpagina.php?transaccion=eliminar&idpagina='.$fila[0].'"><img src="assets/action_delete.png" alt="Delete" /></a><a href="../index.php?idpagina='.$fila[0].'" target="_new"><img src="assets/folder.png" alt="Folder" /></a></td>
								</tr>';
							$i++;	
						}
					?>	
