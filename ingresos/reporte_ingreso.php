...
<?php
    $sql = "select idingreso,recibo,left(glosa,50)as 'glosa',left(nombrepersona,20)as 'nombre'
	,ingresoBolivianos,date_format(fecha,'%d/%m/%Y') as 'fecha' from ingreso
	 where cuenta='$codigoCuenta' and fecha>='$desde' and fecha<='$hasta' and estado=1;";
...
<div class="session1_contenedorTitulos">
   <table width="100%" border="0">
     <tr><td align="center" class="session1_titulo1"><?php echo "INGRESOS DE $tipoReporte" ?></td></tr>
...
<table width="98%"  align="center"  cellspacing="0">
  <tr class="tablainicio">
    ...
    <td width="10%" class="tablainiciotitulo" style="font-size:11px;">Recibo</td>
    ...
    <td width="21%" class="tablainiciotitulo" style="font-size:11px;">Cliente</td>
