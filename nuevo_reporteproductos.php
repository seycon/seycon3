...
<?php
	 ...
	 if (!$db->tieneAccesoFile($estructura['Inventario'],'Tipos de Productos','nuevo_reporteproductos.php')){
...
var viewreporte_prodcuto = function(){
  window.open('productos/reporte_kardex.php?desde='+$$('fecha').value+'&hasta='+$$("fecha2").value+'&almacen='+$$("almacen").value+'&producto='+$$("producto").value,'target:_blank');	
}

var viewreporteMovimiento = function(){
   window.open('productos/reporte_movimiento.php?desde='+$$('fecha3').value+'&hasta='+$$("fecha4").value+'&almacen='+$$("almacen2").value+'&producto='+$$("producto2").value,'target:_blank');		
}


var viewreportetipoProducto = function(){  
  window.open('productos/reporte_tipo_producto.php?idgrupo='+$$('grupo').value,'x:_blank');	
}
  
  
var viewreporte_inventario = function(){
  window.open('productos/reporte_almacen.php?idalmacen='+$$("almacenI").value+'&idgrupo='
  +$$("grupoA").value+'&fecha='+$$("fecha5").value,'target:_blank');	
}  
...
<table cellpadding='0' cellspacing='0' width='99%' align="center" class="contemHeaderTop">
  <tr class='cabeceraInicialListar'> 
    <td height="92" colspan='2' valign="middle">&nbsp;&nbsp; <div class="titleFromReport">
     Reportes de Productos en Almacén</div>
    </td>
<td></td>
<td colspan="3" align='right'>
    ...
    <table width="100%" border="0">
        ...
        <tr>
          ...
          <div class="menuopcionesreporte">
            <div class="botonreporte" id="r1" onclick="viewOptionReporte('r1')">Kardex por Productos</div>
            <div class="espacioreporte"></div>
            <div class="botonreporte2" id="r2" onclick="viewOptionReporte('r2')">Movimientos Productos</div>
            <div class="espacioreporte"></div>
            <div class="botonreporte2" id="r3" onclick="viewOptionReporte('r3')">Reporte Tipo Producto</div>
            <div class="espacioreporte"></div>
            <div class="botonreporte2" id="r4" onclick="viewOptionReporte('r4')">Inventario Producto</div>
          </div></td>
          <td rowspan="2">&nbsp;</td>
  ...
  <tr>
    ...
    <td><select id="almacen" name="almacen" style="width:150px;background:#FFF;border:solid 1px #999;" >
      <?php
			$consulta='select * from almacen where estado=1';
			$res=$db->consulta($consulta);
			while($filas=mysql_fetch_array($res)){				
			?>
      <option value="<?php echo $filas['idalmacen'] ?>"><?php echo $filas['nombre'] ?></option>
      <?php
			}
			?>
    </select></td>
  ...
  <tr>
    ...
    <td><select id="producto" name="producto" style="width:150px;background:#FFF;border:solid 1px #999;" >
      <?php
			$sql='select idproducto,left(nombre,20) from producto where estado=1';
  ...
  <tr>
    ...
    <td><select id="almacen2" name="almacen2" style="width:150px;background:#FFF;border:solid 1px #999;" >
      <?php
			$sql='select idalmacen,nombre from almacen where estado=1';
			$db->imprimirCombo($sql);			
	  ?>
    </select></td>
    <td>&nbsp;</td>
  ...
  <tr>
    ...
    <td>&nbsp;</td>
    <td colspan="2"><input type="button" name="aceptar" id="aceptar" value="Realizar Reporte"
     onclick="viewreporteMovimiento();"  class="botonNegro" style="width:110px;"/></td>
    </tr>
  <tr>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  ...
  <tr>
    ...
    <td><select id="grupo" name="grupo" style="width:150px;background:#FFF;border:solid 1px #999;" >
            <option value="*">-- Todos--</option>
			<?php
			$consulta='select * from grupo where estado=1';
			$res=$db->consulta($consulta);
			while($filas=mysql_fetch_array($res)){				
			?>
            	<option value="<?php echo $filas['idgrupo'] ?>"><?php echo $filas['nombre'] ?></option>           
                    <?php
			}
			?>            
		</select></td>
  ...
  <tr>
    ...
    <td>&nbsp;</td>
    <td colspan="2"><input type="button" name="aceptar" id="aceptar" value="Realizar Reporte"
     onclick="viewreportetipoProducto();"  class="botonNegro" style="width:110px;"/></td>
    </tr>
  <tr>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  ...
  <tr>
    ...
    <td align="right">Grupo:</td>
    <td>
        <select id="grupoA" name="grupoA" style="width:150px;background:#FFF;border:solid 1px #999;" >
			<?php
  ...
  <tr>
    ...
    <td>
    <select id="almacenI" name="almacenI" style="width:150px;background:#FFF;border:solid 1px #999;" >
      <?php
			$sql='select idalmacen, left(nombre, 20) as nombre from almacen where estado=1';
			$db->imprimirCombo($sql);
			?>
    </select>
    </td>
  ...
  <tr>
    ...
    <td>&nbsp;</td>
    <td colspan="2">
    <input type="button" name="aceptar" id="aceptar" value="Realizar Reporte" onclick="viewreporte_inventario();"
      class="botonNegro" style="width:110px;"/>
    </td>
    </tr>
  <tr>
    <td>&nbsp;</td>
