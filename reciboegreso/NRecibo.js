  var servidorPrincipal = 'reciboegreso/DRecibo.php';
  var irDireccion = "listar_reciboegreso.php#t2";
...
var orderNumeroItem = function(){
 ...
 function accionPostRegistro(){
   window.open('reciboegreso/imprimir_reciboEgreso.php?idrecibo='+idreciboIngreso,'target:_blank');	
   cerrarPagina();
 }  

  function cerrarPagina(){
	   location.href = 'nuevo_reciboegreso.php';
  }
