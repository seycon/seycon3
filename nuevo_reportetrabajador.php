...
<?php
	 ...
	 if (!$db->tieneAccesoFile($estructura['Recursos'],'Trabajadores','nuevo_reportetrabajador.php')){
...
var viewreporte_prodcuto = function(){
  window.open('trabajador/reporte_trabajadores.php?sucursal='+$$("sucursal").value,'target:_blank');	
}
...
<table cellpadding='0' cellspacing='0' width='99%' align="center">
  <tr class='cabeceraInicialListar'> 
    <td height="92" colspan='2' valign="middle">&nbsp;&nbsp; <div class="titleFromReport">
     Reportes del Personal de la Empresa</div>
    </td>
<td></td>
 ...
 <div id="datos_factura" class="datos_cliente1">
      <table width="100%" border="0">
          ...
          <tr>
            ...
            <div class="menuopcionesreporte">
              <div class="botonreporte" id="r1" onclick="viewOptionReporte('r1')">Reportes Trabajadores</div>
  ...
  <tr>
    ...
    <input type="button" name="aceptar" id="aceptar" value="Realizar Reporte"
     onclick="viewreporte_prodcuto();"  class="botonNegro" style="width:110px;"/>
    </td>
    </tr>
  <tr>
    <td>&nbsp;</td>
