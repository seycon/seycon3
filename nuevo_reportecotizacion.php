...
<?php
	 ...
	 if (!$db->tieneAccesoFile($estructura['Ventas'],'Cotización','nuevo_reportecotizacion.php')){
...
<td colspan="3" align='right'>
  ...
  <tr>
    ...
    <td>&nbsp;</td>
    <td colspan="2">
    <input type="button" name="aceptar" id="aceptar" value="Realizar Reporte" onclick="viewreporteCaja();" 
  ...
  <tr>
    ...
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td colspan="2"><input type="button" name="aceptar" id="aceptar" value="Realizar Reporte" onclick="viewreporteBanco();" 
      class="botonNegro" style="width:110px;"/></td>
    </tr>
</table>  
  </div>      
