...
<table width="95%" border="0">
  <tr>
    <td><div align="center">
      <p><br />
        <span class="titulopen">Elementos Pendientes</span></p>
      <p><br />
      </p>
      <?php
 ...
 while($datos=mysql_fetch_array($consulta)){
	if ($i==0){ 
    echo "<table width='95%' border='0' align='center' style='min-width:563.2px'>";
    echo  "<tr>"; 
    ...
    echo "<td width='3%'class='color'>Editar</td>";
    echo "</tr>";
	}
	$i=1;
...
$consulta= mysql_query($consulta);
 ...
 while($datos=mysql_fetch_array($consulta)){
	if ($i==0){ 
    echo "<table width='95%' border='0' align='center' style='min-width:638.2px'>";
    echo  "<tr>"; 
