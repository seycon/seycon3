...
$.extend($.validator, {
	...
	messages: {
		...
		dateISO: "Ingrese una fecha correcta.",
		number: "Ingrese un numero valido.",
		digits: "Ingrese solo numeros enteros.",
		creditcard: "Ingrese un numero de tarjeta de credito.",
		...
		rangelength: $.validator.format("Ingrese un valor valido entre {0} y {1} caracteres de largo."),
		range: $.validator.format("Ingrese un valor valido entre {0} y {1}."),
		max: $.validator.format("Ingrese un valor menor o igual a {0}."),
		min: $.validator.format("Ingrese un valor mayor o igual {0}.")
	},
