...
var viewreporte_prodcuto = function(){
   window.open('factura/reporte_ventas_gestion.php?anio='+$$('anio').value+'&tipo='+$$('tipo').value,'target:_blank');
}

var viewreporte_cantidad = function(){
   window.open('factura/reporte_ventaproductos.php?desde='+$$('fecha').value+'&hasta='+$$('fecha2').value
   + "&grupo="+$$("grupo").value ,'target:_blank');
}
...
<table cellpadding='0' cellspacing='0' width='99%' align="center" class="contemHeaderTop">
  <tr class='cabeceraInicialListar'> 
    <td height="92" colspan='2' valign="middle">&nbsp;&nbsp; <div class="titleFromReport">
     Reportes de Ventas de Productos</div>
    </td>
    <td></td>
            ...
            <table width="100%" border="0">
                ...
                <tr>
                  ...
                  <div class="menuopcionesreporte">
                    ...
                    <div class="botonreporte2" id="r2" onclick="viewOptionReporte('r2')">Ventas Por Cantidad</div>
                    <div class="espacioreporte"></div>
