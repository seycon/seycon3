...
//   $idreciboingreso = 11;
   ...
   $idreciboingreso = $_GET['idrecibo'];
   $sql = "select idreciboingreso,idrecibido,nombrerecibido,fecha,pagado,round(totalingreso,2)as 'totalingreso',firma_digital,codigo,responsable from reciboingreso where 
   idreciboingreso=$idreciboingreso";
      ...
      <div class="cen" > 
         <table border="0" style="border:0px solid" width="99%">
          ...
          <tr>
            ...
            <td colspan="2" align="center" class="session1_titulo">RECIBO DE INGRESO</td>
            

          </tr>
          <tr>
            <td width="25%" class="contorno" align="center"><b>Fecha: </b><?php echo $db->GetFormatofecha($maestro['fecha'],'-');?></td>
            <td width="16%" align="center" class="contorno"><b>Nro: </b><?php echo $idreciboingreso;?></td>
          </tr>
          <tr>
            <td class="contorno"><b>Recibimos de: </b><?php echo $maestro['nombrerecibido']?></td>
        ...
        <table width="99%">
          ...
          <table width="99%" class="contorno" cellspacing="0"  style="position:absolute;left:25px;<?php if($maestro['pagado']==1) echo "background-image:url(../images/pagado.png);";?>">
                 ...
                 <col style="width:22%">
					  ...
					  $sql = "select descripcion,round(ingreso,2)as 'ingreso' from detallereciboingreso where idreciboingreso=$idreciboingreso;";
					  ...
					  if ($contador==1){						
						echo "
					       <tr>
                              <td width='10.5%' style='border-right:1px solid #CCC;font-size:11px' align=center>$contador</td>
                              <td width='71.5%' style='border-right:1px solid #CCC;font-size:11px'>&nbsp;&nbsp;$consulta[descripcion]</td>
                              <td width='18%' style='font-size:11px' align=center>".number_format($consulta['ingreso'],2)."</td>
                          </tr><tr >    	
						";  
					  }
					  else{					  
					  echo "<tr>
					          <td  style='border-right:1px solid #CCC;font-size:11px' align=center>$contador</td>
							  <td  style='border-right:1px solid #CCC;font-size:11px' >&nbsp;&nbsp;$consulta[descripcion]</td>
					          <td  align=center style='font-size:11px'>".number_format($consulta['ingreso'],2)."</td>
					        </tr>";								
					      }
