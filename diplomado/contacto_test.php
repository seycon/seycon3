<?php
include_once 'elements/procesar_contacto_test.php';
?>
                    ...
                    <div  style="letter-spacing: 0.2px;word-spacing: 2px;"id="content-bigger2" class="content-middle">                        
                        ...
                        <div class="contact_options">
                            ...
                            <div id="message" style="display: none;" class="contact_option">
                                ...
                                <form  class="contact_form" action="contacto_test.php" method="post" onsubmit="return message_validation()">
                            ...
                            <div id="suggest" style="display: none;" class="contact_option">
                                ...
                                <form  class="contact_form" action="contacto_test.php" method="post" onsubmit="return suggest_validation()">
