...
<script language="javascript">
	function eliminarTransaccion(){
	  location.href = "anular_registro.php?idplanilla="+$$("idDelete").value
	  +"&tabla=planilla&menu=4&libro=Sueldos&tipolibro=egreso"+ "&salto=pagosueldos";
	}
	...
	var openMensaje = function(codigo){
		...
		$$("modal_contenido").innerHTML = '¿Desea anular esta Planilla de Sueldos?';
...
<form name="listado" id="listado" method='get' action='listar_pagosueldos.php#t4' enctype='multipart/form-data'>
...
<?php
    ...
    $sql = "select b.idplanilla,month(b.fecha),year(b.fecha),left(s.nombrecomercial,30)
	,left(concat(t.nombre,' ',t.apellido),35)as 'usuario' 
	from planilla b,trabajador t,usuario u,trabajador tb,sucursal s where b.idusuario=u.idusuario 
