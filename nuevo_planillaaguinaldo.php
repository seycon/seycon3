...
if (!$db->tieneAccesoFile($estructura['Recursos'],'Planilla de Aguinaldo','nuevo_planillaaguinaldo.php')){
...
<form id="form2" name="form2" method="post" action="planillas/imprimir_planillaAguinaldos.php#t10" target="_blank">
...
<table width="356" border="0">
  <tr>
    ...
    <td width="320" align="center"> Reporte Planilla de Aguinaldo</td>
  </tr>
  <tr>
...
<table width="100%" height="138" border="0" align="center">
    <tr>
      <td>&nbsp;</td>
      <td class="titulos" align="left"></td>
      <td>&nbsp;</td>
      <td class="titulos">&nbsp;</td>
      <td>&nbsp;</td>
      <td class="titulos">&nbsp;</td>
    ...
    <tr>
      <td width="1%">&nbsp;</td>
      <td width="26%" class="titulos" align="right">&nbsp;</td>
      <td width="16%">&nbsp;</td>
      <td width="3%" class="titulos">&nbsp;</td>
      <td width="8%">&nbsp;</td>
    ...
    <tr>
      <td colspan="8"><table width="90%" border="0" align="center" class="bordeContenido">
        ...
        <tr>
          ...
          <td width="24%"><span class="titulos">
