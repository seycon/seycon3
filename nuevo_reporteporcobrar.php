<?php
 ...
 $estructura = $_SESSION['estructura'];
  if (!$db->tieneAccesoFile($estructura['Agenda'],'Reporte Financiero','nuevo_reporteporcobrar.php')){
...
value="<?php echo date("d/m/Y");?>"  class="date" size="10" />
  ...
  <td width='60' align="left" valign='top'><input type='checkbox' id='auxiliares' onchange="mostrarAuxiliares()"  name='auxiliares' checked="checked"   class="" size="32" /></td>
...
<tr>
  ...
  <td width="128">&nbsp;</td>
  <td width="156" colspan="2" align='right'>&nbsp;</td>   
  <td width="103">&nbsp;</td>
</tr>
...
<tr>
  <td colspan='6' >
    ...
    <table width='100%' border='0' align='center'>
      <tr>
        <td width="283" align="right" valign="top">
