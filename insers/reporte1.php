...
<table width="300" border="0">
  ...
  <tr>
    ...
    <table width="266" border="0" align="center" cellspacing="0">
  <tr>
    <td width="54" align="center" class="textocabecera1">Cant.</td>
    <td width="90" align="center" class="textocabecera1">Producto</td>
    <td width="41" align="center" class="textocabecera1">P/U</td>
    <td width="73" align="center" class="textocabecera1">P/Total</td>
  </tr>
  <?php
