<?php 
    ...
    if ($_GET['transaccion'] == "insertar") { 
        ...
        $sql = "INSERT INTO configuracionrestaurante(idconfiguracion,guardiam1,guardiam2"
            ...
            ."pantallatv,impresiontv,cuentasocio,cuentacortesia,cuentadescuento,ventaminima,exigibleapoyo,gastosapoyo) VALUES "
			...
			'$_GET[cuentadescuento]','$_GET[ventaminima]','$_GET[exigibleapoyo]','$_GET[gastosapoyo]');";
        $db->consulta($sql);  
