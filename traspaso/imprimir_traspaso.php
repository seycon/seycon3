...
//$idtransaccion = 1;
$idtransaccion = $_GET['idtraspaso'];
$sql = "select idtraspaso,nombrepersona,date_format(fecha,'%d/%m/%Y')as 'fecha',recibo,cheque,left(p.cuenta,25)as 'cuenta',i.glosa,
...
$sql = "select left(p.cuenta,25)as 'cuenta',left(concat(t.nombre,' ',t.apellido),40)as 'nombre',d.montobolivianos,d.montodolares 
 from detalletraspasodinero d,plandecuenta p,trabajador t where 
 d.idcuenta=p.codigo and t.idtrabajador=d.idtrabajador and idtraspaso=$idtransaccion;";
...
function datosGenerales($dato,$persona){	
  ...
  <tr>
    <td width='14%' class='session2_titulos'>".ucfirst(($dato['tipopersona'])).":</td>
    <td width='35%' class='session2_titulosDatos'>$persona</td>
  ...
  <tr>
    <td class='session2_titulos'>Cuenta Origen:</td>
...
function insertarFila($num,$dato,$total,$tc){
  ...
  echo " <tr>
    ...
    <td class='session3_datos1_1' align='left' >".$dato['cuenta']."</td>
...
function insertarTotal($total,$tc){
  ...
  echo "<tr>
    ...
    <td class='session3_contornoSuperior'  align='left'></td>
...
<link rel="stylesheet" href="traspaso.css" type="text/css" />
...
<div class="session1_contenedorTitulos">
   <table width="100%" border="0">
     <tr><td align="center" class="session1_titulo1">TRASPASO DE DINERO</td></tr> 
    </table>
</div>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" align="center"> 
  <tr>
    ...
    <td  width="37%" class="session3_titulosCabecera" >Destino</td>
    <td width="25%" class="session3_titulosCabecera" >Caja o Banco</td>
...
<table width="100%" border="0" align="center">
  <tr>
    <td colspan="2" class="textoGlosa" align="left"><?php echo "<strong>Glosa:</strong> ".$datosGenerales['glosa'];?></td>
  </tr>
</table>
