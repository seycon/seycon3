...
<?php
	 ...
	 if (!$db->tieneAccesoFile($estructura['Inventario'],'Combinación','nuevo_reportecombinacion.php')){
...
var viewreporte_prodcuto = function() {
  window.open('combinacion/reporte_combinacion.php?tipocombinacion='+$$("tipo").value,'target:_blank');	
}
            ...
            <table width="100%" border="0">
                ...
                <tr>
                  ...
                  <div class="menuopcionesreporte">
                    <div class="botonreporte" id="r1" onclick="viewOptionReporte('r1')">Combinaciones</div>
