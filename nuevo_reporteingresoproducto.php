...
var viewreporte_prodcuto = function(){
  window.open('ingresoalmacen/reporte_ingreso_producto.php?desde='+$$('desde').value+'&hasta='+$$("hasta").value+'&idalmacen='+$$("almacen").value+'&idproducto='+$$("producto").value,'target:_blank');	
}

var viewreporte_ingreso = function(){
  window.open('ingresoalmacen/reporte_ingresodetallado.php?desde='+$$('fecha3').value+'&hasta='+
  $$("fecha4").value+'&almacen='+$$("almacenID").value
  ,'target:_blank');	
}   
...
<table cellpadding='0' cellspacing='0' width='99%' align="center" class="contemHeaderTop">
  <tr class='cabeceraInicialListar'> 
    <td height="92" colspan='2' valign="middle">&nbsp;&nbsp; <div class="titleFromReport">
     Reportes de Ingreso de Productos</div>
    </td>
<td></td>
<td colspan="3" align='right'>
            ...
            <table width="100%" border="0">
                ...
                <tr>
                  ...
                  <div class="menuopcionesreporte">
                    <div class="botonreporte" id="r1" onclick="viewOptionReporte('r1')">Ingreso de Producto</div>
                    <div class="espacioreporte"></div>
                    <div class="botonreporte2" id="r2" onclick="viewOptionReporte('r2')">Ingreso Detallado</div>
  ...
  <tr>
    ...
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td colspan="2"><input type="button" name="aceptar" id="aceptar" value="Realizar Reporte" onclick="viewreporte_prodcuto();" 
  ...
  <tr>
    <td>&nbsp;</td>
    <td align="right">Almacen:</td>
    <td><select id="almacenID" name="almacenID" style="width:150px;background:#FFF;border:solid 1px #999;" >            
		<?php
  ...
  <tr>
    ...
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td colspan="2"><input type="button" name="aceptar" id="aceptar" value="Realizar Reporte" onclick="viewreporte_ingreso();" 
     class="botonNegro" style="width:110px;"/></td>
    </tr>
