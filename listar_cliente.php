...
<?php
	...
	$fileAcceso = $db->privilegiosFile($estructura['Ventas'],'Clientes','listar_cliente.php','nuevo_cliente.php');
...
function eliminarTransaccion(){
  location.href = "anular_registro.php?idcliente="+$$("idDelete").value+"&tabla=cliente&menu=8";
}
...
var openMensaje = function(codigo){
	...
	$$("modal_contenido").innerHTML = '¿Desea anular este Cliente?';
...
<form name="listado" id="listado" method='get' action='listar_cliente.php#t8' enctype='multipart/form-data'>
      ...
      <div class="listadoCombo1">
          <div class="borde1Listar"> </div>
            <select id="campo" name="campo" class="borde2Combo1">
              <?php
				 	echo "<option value=idcliente>Nº</option>";
					echo "<option value=nombre>Nombre</option>";
					echo "<option value=nombrenit>Nombre Nit</option>";
...
<td width='151' style='font-family: Verdana, Geneva, sans-serif;' align="right"> 
 Activos </td>
<?php
...
$sql = 'SELECT idcliente,nombre,nombrenit,telefono,nit,ciudad from cliente'.$condicion.' order by idcliente desc';
...
<?php
$nombres = array(  "Nº", "Nombre", "Nombre N.I.T.", "Teléfono", "NIT", "Ciudad" );
...
if ($fileAcceso['Modificar'] == "Si"){ 
	echo "<td><div align='center'><a href='nuevo_cliente.php?idcliente=".$id."&sw=1#t8' onclick='return modificar(this)'> <img src='css/images/edit.gif' title='Modificar' alt='editar' border='0' /><br /></a></div></td>";
	}else{
