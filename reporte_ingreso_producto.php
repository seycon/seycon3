...
<form id='formValidado' name='formValidado' method='post' action='reportes/reportes_inventario/ingreso_producto.php' target="_blank" enctype='multipart/form-data'>
...
<tr>
<td colspan='4'>
<input name='enviar' type='submit' class='botonseycon' id='enviar' value='Generar' /></td>
...
<tr>
  ...
  <td valign='top'><select name="idalmacen" id="idalmacen" >
...
<tr>
  ...
  <td valign='top'><select name="formapago" id="formapago" >
