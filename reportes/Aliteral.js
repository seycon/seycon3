...
function covertirNumLetras(number,resul)
{
 ...
 //  try{ 
   ...
   centavos = "" + centavos;
 /*  } catch (e){
	  $v('total_pie').rows[0].cells[1].innerHTML = '';
      $v('total_pie').rows[3].cells[1].innerHTML = '';
	  $v('descuento').value = '';
 //  }*/
   ...
   /* Regresa el número en cadena entre paréntesis y con tipo de moneda y la fase M.N.*/
    dato = "Son: "+cad +" "+centavos+money;
		
   $v(resul).innerHTML = "Son: "+cad +" "+centavos+money;
