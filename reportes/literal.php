...
if ($Numero >= 100 && $Numero< 101){
	if ($num>1 && func_get_arg(1) == "Dolares")
     return "Cien $Decimales/100 Dolares";
    else
     return "Cien $Decimales/100 Bolivianos";
}
...
$num = func_num_args();
if ($num>1 && func_get_arg(1) == "Dolares")
$letras .= " ".$dec."/100 Dolares";
else
$letras .= " ".$dec."/100 Bolivianos";
return ucfirst($letras);
}
}


//echo NumerosALetras("531.50");
