<?php
  session_start();
  if (!isset($_SESSION['idusuarioF']) || !isset($_GET['idatencion']) || !isset($_GET['nroatencion'])){
...
<table width="100%" border="0">
  ...
  <tr>
    <td colspan="5" align="center" class="textotipo1">COMANDA</td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  ...
  <tr>
    ...
    <td width="40%" align="center" class="textotipo1">Producto</td>
    <td width="22%" align="center" class="textotipo1">P/U</td>
  ...
  $sql = "select da.iddetallenotaf,left(c.nombre,25)as 'nombre',da.cantidad,da.precio,da.nroatencion from detallenotaF da,combinacion c,notaventaF n where 
					...
					and da.nroatencion=$nroatencion and da.estado=1 order by da.iddetallenotaf;";
