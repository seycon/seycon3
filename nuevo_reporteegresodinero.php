...
<?php
	 ...
	 if (!$db->tieneAccesoFile($estructura['Contabilidad'],'Egreso de Dinero','nuevo_reporteegresodinero.php')) {
...
var viewOptionReporte = function(value){
   var opciones = ['r1', 'r2', 'r3', 'r4', 'r5'];
   var contenedor = ['r-1', 'r-2', 'r-3', 'r-4', 'r-5'];
...
var viewreporteCaja = function(){
  window.open('egresos/reporte_egresodinero.php?tipo=caja&desde='+$$('fecha').value+'&hasta='+$$("fecha2").value
  +'&cuenta='+$$("cuenta").value+"&moneda=" + $$("monedacaja").value,'target:_blank');	
}

var viewreporteBanco = function(){
  window.open('egresos/reporte_egresodinero.php?tipo=banco&desde='+$$('fecha3').value+'&hasta='+$$("fecha4").value
  +'&cuenta='+$$("cuenta2").value+"&moneda=" + $$("monedabanco").value,'target:_blank');	
}

var viewreporteEgresoCliente = function(){
  window.open('egresos/reporte_egresocliente.php?idbeneficiario='
...
var viewreporteEgresoCuenta = function(){
  window.open('egresos/reporte_egresocuenta.php?cuenta='+$$("modeloplan").value+'&desde='+$$('fecha9').value
  +'&hasta='+$$("fecha10").value+'&caja='+$$("cuenta8").value
  +"&moneda=" + $$("monedacuenta").value,'target:_blank');	
}


var viewreporteComparativo = function (){
  window.open('egresos/reporte_ingreso_egreso.php?anio='+$$("anio").value+'&sucursal='+$$('sucursal').value
   ,'target:_blank');		
}
...
<table cellpadding='0' cellspacing='0' width='99%' align="center" class="contemHeaderTop">
  <tr class='cabeceraInicialListar'> 
    <td height="92" colspan='2' valign="middle">&nbsp;&nbsp; <div class="titleFromReport">
     Reportes de Egreso de Dinero</div>
    </td>
<td></td>
<td colspan="3" align='right'>
 ...
 <table width="100%" border="0">
    ...
    <tr>
      ...
      <div class="menuopcionesreporte">
        <div class="botonreporte" id="r1" onclick="viewOptionReporte('r1')"> Egreso Caja</div>
        <div class="espacioreporte"></div>
        <div class="botonreporte2" id="r2" onclick="viewOptionReporte('r2')">Egreso Banco</div>
        <div class="espacioreporte"></div>
        <div class="botonreporte2" id="r3" onclick="viewOptionReporte('r3')">Egreso Por Beneficiario</div>
        <div class="espacioreporte"></div>
        <div class="botonreporte2" id="r4" onclick="viewOptionReporte('r4')">Egreso Por Cuenta</div>
        <div class="espacioreporte"></div>
        <div class="botonreporte2" id="r5" onclick="viewOptionReporte('r5')">Comparativo I & E</div>
      
      </div></td>
      <td rowspan="2">&nbsp;</td>
      <td colspan="2" rowspan="2" valign="top">
                  
  <!-- Reporte Egreso de Caja -->                
 ...
 <table width="100%" border="0">
  ...
  <tr>
    ...
    <td align="right">Moneda:</td>
    <td>
    <select id="monedabanco" name="monedabanco">
        <option value="Bolivianos">Bolivianos</option>
        <option value="Dolares">Dolares</option> 
    </select>
    </td>
  ...
  <tr>
   ...
   <!-- Reporte Egreso por beneficiario -->    
 ...
 <tr>
    ...
    <td align="right">Moneda:</td>
    <td>
    <select id="monedacliente" name="monedacliente">
        <option value="Bolivianos">Bolivianos</option>
        <option value="Dolares">Dolares</option> 
    </select>
    </td>
  ...
  <tr>
    ...
    <td colspan="2">
    <input type="button" name="aceptar" id="aceptar" value="Realizar Reporte" 
    onclick="viewreporteEgresoCliente();"  class="botonNegro" style="width:110px;"/></td>
    </tr>
</table>           
      ...
      <select name="modeloplan" id="modeloplan"  style="width:190px;">
         <option value="">--Seleccione una Cuenta--</option>
		  ...
		  where pp.codigo=( left(ph.codigo,2) ))as 'padre',ph.codigo,ph.cuenta,ph.nivel
		   from plandecuenta ph  where ph.nivel>=5 and estado=1 and left(ph.codigo,1)=6 order by ph.codigo;";
  ...
  <tr>
    ...
    <td align="right">Moneda:</td>
    <td>
    <select id="monedacuenta" name="monedacuenta">
        <option value="Bolivianos">Bolivianos</option>
        <option value="Dolares">Dolares</option> 
    </select>
    </td>
  ...
  <tr>
    ...
    <td colspan="2">
    <input type="button" name="aceptar" id="aceptar" value="Realizar Reporte" 
    onclick="viewreporteEgresoCuenta();"  class="botonNegro" style="width:110px;"/></td>
    </tr>
</table>           
    ...
    <!-- Reporte Comparativo Ingreso y Egresos-->         
  ...
  <tr>
    ...
    <td><select id="anio" name="anio" style="width:130px;background:#FFF;border:solid 1px #999;" >
                      <?php
                              for ($i=0; $i <=5 ; $i++) {
                                    $anio=(date ("Y")-$i);
  ...
  <tr>
    ...
    <td>    
      ...
      <option value="" selected="selected">Consolidado</option>
      <?php
	    $sql = "select idsucursal,left(nombrecomercial,15)as 'nombrecomercial' 
		from sucursal where estado=1 order by nombrecomercial"; 
  ...
  <tr>
    ...
    <td colspan="2">
    <input type="button" name="aceptar" id="aceptar" value="Realizar Reporte" 
    onclick="viewreporteComparativo();"  class="botonNegro" style="width:110px;"/></td>
    </tr>
</table>        
</div>   
