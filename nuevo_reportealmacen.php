...
<?php
	 ...
	 $estructura = $_SESSION['estructura'];
	  if (!$db->tieneAccesoFile($estructura['Inventario'],'Almacén','nuevo_reportealmacen.php')){
...
var viewreporte_prodcuto = function(){
  window.open('almacen/reporte_stockProductos.php?hasta='+$$("hasta").value+'&almacen='+$$("almacen").value+'&grupo='+$$("grupo").value,'target:_blank');	
}
...
<div id="factura" class="cen">     
     <table cellpadding='0' cellspacing='0' width='100%' class="contemHeaderTop" align="center">
      <tr class='cabeceraInicialListar'> 
        <td height="92" colspan='2' valign="middle">&nbsp;&nbsp; <div class="titleFromReport">
         Reportes de Almacén</div>
        </td>
        <td></td>
            ...
            <table width="100%" border="0">
                ...
                <tr>
                  ...
                  <div class="menuopcionesreporte">
                    <div class="botonreporte" id="r1" onclick="viewOptionReporte('r1')">Stock de Productos</div>
  ...
  <tr>
    ...
    <td>
    <select id="almacen" name="almacen" style="width:150px;background:#FFF;border:solid 1px #999;" >
      <?php
  ...
  <tr>
    ...
    <td>&nbsp;</td>
    <td colspan="2">
    <input type="button" name="aceptar" id="aceptar" value="Realizar Reporte" onclick="viewreporte_prodcuto();" 
     class="botonNegro" style="width:100px;"/>
    </td>
    </tr>
  <tr>
    <td>&nbsp;</td>
