...
<?php
	...
	$fileAcceso = $db->privilegiosFile($estructura['Contabilidad'],'Impuesto Mensual'
	,'listar_impuestos.php','nuevo_impuestos.php');
...
function eliminarTransaccion(){
  location.href = "anular_registro.php?idimpuesto="+$$("idDelete").value+"&tabla=impuesto&menu=10&reg=impuestos&salto=impuestos";
}
...
var openMensaje = function(codigo){
	...
	$$("modal_contenido").innerHTML = '¿Desea anular este Impuesto?';
...
<form name="listado" id="listado" method='post' action='listar_impuestos.php#t10' enctype='multipart/form-data'>
      ...
      <div class="listadoCombo2">
          <div class="borde1Listar"> </div>
            <select id="campo" name="campo" class="borde2Combo1">
              <?php
				echo "<option value=idimpuesto>Nº</option>";
				echo "<option value=tipocambio>Tipo Cambio</option>"; 
			  ?>
            </select>
   </div> 
...
<tr>
<td width='544' ><? if (isset($_POST['estado']) && ($_POST['estado'] == 0))  echo '';?></td>
...
if (isset($_POST['abuscar'])){
 $cFecha = ($_POST['fecha'] == "") ? "" : " fechavencimiento ='".$db->GetFormatofecha($_POST['fecha'],'/')."' and ";	
 $condicion = "where i.idusuario=u.idusuario and u.idtrabajador=t.idtrabajador and ".$_POST['campo']." like '".$_POST['abuscar']."%' and $cFecha i.estado=".$_POST['estado'];
}else 
if (isset($_POST['estado'])) 
$condicion = " where i.idusuario=u.idusuario and u.idtrabajador=t.idtrabajador and i.estado= ".$_POST['estado'];
else  
$condicion = ' where i.idusuario=u.idusuario and u.idtrabajador=t.idtrabajador and i.estado=1 ';


$sql = "select idimpuesto,date_format(fechavencimiento,'%d/%m/%Y')as 'fechavencimiento',round(tipocambio,2) from impuestos i,usuario u,trabajador t 
  ".$condicion." order by idimpuesto desc";
mysql_query("SET NAMES 'utf8'");
$res = consulta($sql);
$n = mysql_num_rows($res);

$nombres = array(  "Nº", "Fecha Vencimiento", "Tipo Cambio" );
...
if (isset($_POST['estado']) && ($_POST['estado'] == 0)) {	
	...
	echo "<td><div align='center'><a href='nuevo_impuestos.php?idimpuesto=".$id."&sw=1#t10'
	...
	echo "<td><div align='center'><a href='librodiario/imprimir_libro.php?idlibrodiario=".$id."'
