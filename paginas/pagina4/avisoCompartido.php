<?php 
	...
	$db = new MySQL();
    $sql = "select * from pagina where idplantilla=4 and numero=1;";  
...
<div class="contemDataCompartido">
  ...
  style="position:relative;float:left;margin:5px 15px 8px 0;" width="150" height="150"/>
  </a>
  <?php }?>
