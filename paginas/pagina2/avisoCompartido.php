<?php 
	...
	$db = new MySQL();
    $sql = "select * from pagina where idplantilla=2 and numero=1;";  
    $pagina = $db->arrayConsulta($sql);
    $sql = "select * from plantilla where idplantilla=2;";
...
<div class="contemData">
 ...
 ?>
  ...
  style="position:relative;float:left;margin:5px 15px 8px 0;" width="200" height="200"/>
  </a>
  <?php }?>
  ...
  <?php }?>  
   ...
   <?php echo $avisoCompartido['descripcion'];?>     
...
<div class="contemCompartido">
    ...
    <?php
	 ...
	 (c.tipo='publico' or c.idplantilla=2) order by c.idcompartido desc;";
