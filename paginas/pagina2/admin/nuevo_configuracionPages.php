<?php
    ...
    if (isset($_POST['transaccion'])) {  
		...
		$sql[0] = "delete from contenido where idpagina=$_SESSION[IDpagina] and session!='imagen lateral' 
		 and session!='imagen galeria 1' and session!='imagen galeria 2' and session!='imagen contenido 1' 
		 and session!='imagen contenido 2' 
		 and session!='imagen galeria 3' and session!='imagen galeria 4' and session!='imagen galeria 5'";
		 
	    $sql[1] = "insert into contenido(session,contem,idpagina) values
		('titulo principal','$_POST[Ctitulop]',$_SESSION[IDpagina])";
				
		$sql[2] = "insert into contenido(session,contem,idpagina) values
		('titulo contenido presentacion','$_POST[Otitulo1]',$_SESSION[IDpagina])";
		$sql[3] = "insert into contenido(session,contem,idpagina) values
		('contenido presentacion','$_POST[Ocontenido1]',$_SESSION[IDpagina])";
		$sql[4] = "insert into contenido(session,contem,idpagina) values
		('contenido lateral','$_POST[Ocontenido2]',$_SESSION[IDpagina])";
		$sql[5] = "insert into contenido(session,contem,idpagina) values
		('titulo contenido principal','$_POST[Otitulo3]',$_SESSION[IDpagina])";
		$sql[6] = "insert into contenido(session,contem,idpagina) values
		('contenido principal','$_POST[Ocontenido3]',$_SESSION[IDpagina])";
		$sql[7] = "insert into contenido(session,contem,idpagina) values
		('titulo contenido secundario','$_POST[Otitulo4]',$_SESSION[IDpagina])";
		$sql[8] = "insert into contenido(session,contem,idpagina) values
		('contenido secundario','$_POST[Ocontenido4]',$_SESSION[IDpagina])";
		...
		('descripcion imagen 1','$_POST[GdescripcionI1]',$_SESSION[IDpagina])";
		$sql[17] = "insert into contenido(session,contem,idpagina) values
		('descripcion imagen 2','$_POST[GdescripcionI2]',$_SESSION[IDpagina])";
		$sql[18] = "insert into contenido(session,contem,idpagina) values
		('descripcion imagen 3','$_POST[GdescripcionI3]',$_SESSION[IDpagina])";
		$sql[19] = "insert into contenido(session,contem,idpagina) values
		('descripcion imagen 4','$_POST[GdescripcionI4]',$_SESSION[IDpagina])";
		$sql[20] = "insert into contenido(session,contem,idpagina) values
		('descripcion imagen 5','$_POST[GdescripcionI5]',$_SESSION[IDpagina])";
	   ...
	   //imagen secundaria
	   $hora = time();	   
	    $nombre = $_FILES['Oimagen3']['name'];
	   if ($nombre != "" ) {
	       copy($_FILES['Oimagen3']['tmp_name'],"../file/$hora$nombre");		   
	   ...
	   if ($nombre != "" ) {
        ...
        header("Location: nuevo_configuracionPages.php?estadoT=v");
    }   
...
<div class="contem2">
   ...
   <form id="formulario" name="formulario" method="post" action="nuevo_configuracionPages.php" enctype="multipart/form-data">   
   ...
   <div class="boton2M"><input type="reset" class="boton" value="Cancelar"/></div>
     ...
     <div id="Mcabecera" class="contemMenu">
     <?php
     ...
     <?php
	  $sql = "select * from contenido where session='descripcion imagen 1' and idpagina=$_SESSION[IDpagina]";
	  $desc1 = $db->arrayConsulta($sql);
      $sql = "select * from contenido where session='descripcion imagen 2' and idpagina=$_SESSION[IDpagina]";
	  $desc2 = $db->arrayConsulta($sql);
	  $sql = "select * from contenido where session='descripcion imagen 3' and idpagina=$_SESSION[IDpagina]";
	  $desc3 = $db->arrayConsulta($sql);
	  $sql = "select * from contenido where session='descripcion imagen 4' and idpagina=$_SESSION[IDpagina]";
	  $desc4 = $db->arrayConsulta($sql);
	  $sql = "select * from contenido where session='descripcion imagen 5' and idpagina=$_SESSION[IDpagina]";
	 ...
	 ?>
      ...
      <table width="90%" border="0" align="center">
        ...
        <tr>
          <td width="5%">&nbsp;</td>
          <td width="10%" align="right" class="textoSubContem">Imagen 1:</td>
          <td width="20%" align="left" class="textoSubContem">
          <input type="text" id="GdescripcionI1"  name="GdescripcionI1" value="<?php echo $desc1['contem']?>"/></td>
          <td width="30%"><input type="file" name="Gimagen1" id="Gimagen1" class="file_1"/></td>
          <td width="35%">
          <div class="globo"><div class="globoleft"></div><div class="globomensaje">967 Ancho x 330 Alto</div></div>
          </td>
        </tr>
        <tr>
          <td>&nbsp;</td>
          <td align="right" class="textoSubContem">Imagen 2:</td>
          <td align="left" class="textoSubContem">
          <input type="text" id="GdescripcionI2"  name="GdescripcionI2" value="<?php echo $desc2['contem']?>"/></td>
          <td><input type="file" name="Gimagen2" id="Gimagen2" class="file_1"/></td>
          <td><div class="globo"><div class="globoleft"></div><div class="globomensaje">967 Ancho x 330 Alto</div></div></td>
        </tr>
        <tr>
          <td>&nbsp;</td>
          <td align="right" class="textoSubContem">Imagen 3:</td>
          <td align="left" class="textoSubContem">
          <input type="text" id="GdescripcionI3"  name="GdescripcionI3" value="<?php echo $desc3['contem']?>"/></td>
        ...
        <tr>
          ...
          <td align="left" class="textoSubContem">
          <input type="text" id="GdescripcionI4"  name="GdescripcionI4" value="<?php echo $desc4['contem']?>"/></td>
        ...
        <tr>
          ...
          <td align="left" class="textoSubContem">
          <input type="text" id="GdescripcionI5"  name="GdescripcionI5" value="<?php echo $desc5['contem']?>"/></td>
     ...
     <div id="Mcontenido" >
      <?php
	  $sql = "select * from contenido where session='titulo contenido presentacion' and idpagina=$_SESSION[IDpagina]";
	  $tc = $db->arrayConsulta($sql);
	  $sql = "select * from contenido where session='contenido presentacion' and idpagina=$_SESSION[IDpagina]";
     ...
     <table width="100%" border="0" align="center">
        ...
        <tr>
          <td>&nbsp;</td>
          <td colspan="3" class="textoTitulo">Contenido Presentación</td>
          <td>&nbsp;</td>
        </tr>
        <tr>
          <td width="5%"></td>
        ...
        <tr>
          ...
          <td width="42%" align="left"><div class="globo"><div class="globoleft"></div><div class="globomensaje">60 Ancho x 50 Alto
          </div></td>
          <td ></td>
        </tr>
        <tr>
        ...
        <tr>
          <td>&nbsp;</td>
          <td align="right" class="textoSubContem">Titulo:</td>
          <td colspan="2"><input type="text" name="Otitulo3" id="Otitulo3" class="field" value="<?php echo $tcp['contem'];?>"/></td>
          <td>&nbsp;</td>
        </tr>
        <tr>
          <td>&nbsp;</td>
        ...
        <tr>
          ...
          <?php echo $contp['contem'];?></textarea></td>
          <td>&nbsp;</td>
        </tr>
        <tr>
          <td></td>
        ...
        <tr>
          <td></td>
          <td colspan="3" align="left"><span class="textoTitulo">Contenido Secundario</span></td>
          <td></td>
        </tr>
        <tr>
          <td></td>
        ...
        <tr>
          <td></td>
          <td align="right"><span class="textoSubContem">Titulo:</span></td>
          <td colspan="2" align="left">
          <input type="text" name="Otitulo4" id="Otitulo4" class="field" value="<?php echo $tcs['contem'];?>"/></td>
          <td></td>
        </tr>
        <tr>
          <td></td>
          <td align="right"><span class="textoSubContem">Imagen:</span></td>
          <td align="left"><input type="file" name="Oimagen3" id="Oimagen3" class="file_1"/></td>
          <td align="left">
          <div class="globo"><div class="globoleft"></div><div class="globomensaje">200 Ancho x 200 Alto</div></td>
          <td></td>
        </tr>
        <tr>
          <td></td>
          <td align="right" valign="top"><span class="textoSubContem">Contenido:</span></td>
          <td colspan="2" align="left"><textarea id="Ocontenido4" name="Ocontenido4" style="width:500px;height:200px;">
	 ...
	 ?>
        ...
        <tr>
          <td>&nbsp;</td>
          <td align="right" valign="top" class="textoSubContem">Contenido:</td>
          <td><textarea id="Pcontenido3" name="Pcontenido3" style="width:500px;height:200px;">
		  <?php echo $cont3['contem'];?></textarea></td>
          <td>&nbsp;</td>
        </tr>
        <tr>
          <td></td>
