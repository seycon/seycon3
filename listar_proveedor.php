...
<?php
 ...
 $fileAcceso = $db->privilegiosFile($estructura['Inventario'],'Proveedores','listar_proveedor.php','nuevo_proveedor.php');
...
function eliminarTransaccion(){
  location.href = "anular_registro.php?idproveedor="+$$("idDelete").value+"&tabla=proveedor&menu=8";
}
...
var openMensaje = function(codigo){
	...
	$$("modal_contenido").innerHTML = '¿Desea anular este Proveedor?';
...
<form name="listado" id="listado" method='get' action='listar_proveedor.php#t8' enctype='multipart/form-data'>
      ...
      <div class="listadoCombo1">
          <div class="borde1Listar"> </div>
            <select id="campo" name="campo" class="borde2Combo1">
              <?php
				echo "<option value=idproveedor>Nº</option>";
				echo "<option value=nombre>Nombre Comercial</option>";
...
<?php
	...
	$sql = 'SELECT idproveedor,nombre,nombrenit,nit,contacto,telefono,email from proveedor'.$condicion.' order by idproveedor desc';
...
$nombres = array(  "Nº", "Nombre Comercial", "Nombre Nit", "N.I.T.", "Contacto", "teléfono", "Email" );
...
if ($fileAcceso['Modificar'] == "Si"){ 
	 echo "<td><div align='center'><a href='nuevo_proveedor.php?idproveedor=".$id."&sw=1#t8' onclick='return modificar(this)'> <img src='css/images/edit.gif' title='Modificar' alt='editar' border='0' /><br /></a></div></td>";
	}else{
