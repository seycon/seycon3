...
$sql = "SELECT idporpagar,c.numerocuenta, DATE_FORMAT( fecha,  '%d/%m/%Y' ) AS  'fecha', tipodeudor, tipocambio, left(s.nombrecomercial,18)as 'nombrecomercial', c.moneda, iddeudor, p.cuenta, glosa,  
left(concat(t.nombre,' ',t.apellido),40)as 'usuario', ROUND( monto, 2 ) AS  'monto',left(c.documento,20)as 'documento' 
FROM cuentaporpagar c, sucursal s, plandecuenta p, trabajador t,usuario u   
WHERE c.idsucursal = s.idsucursal 
AND c.idusuario = u.idusuario 
AND u.idtrabajador = t.idtrabajador  
AND p.codigo=c.cuenta  
AND idporpagar =$idcuenta;";
...
<link rel="stylesheet" href="cuentapagar.css" type="text/css" />
...
<div class="session1_numTransaccion">
 <table width="100%" border="0">
      ...
      <tr><td class="session1_titulo_num"><?php echo "Nº ".$datosCuenta['idporpagar']; ?></td></tr> 
 </table>
</div>
...
<div class="session1_contenedorTitulos">
   <table width="100%" border="0">
     <tr><td align="center" class="session1_titulo1">CUENTA POR PAGAR</td></tr> 
    </table>
</div>
