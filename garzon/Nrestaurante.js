// JavaScript Document
 ...
 var limpiarTrabajador = function() {
  ...
  var calcularFaltanteEntrega = function(id){
 ...
 var resultadoEntrega = function(resultado){
	getDatosVentaEntrega(resultado);
 }
 
 var getDatosVentaEntrega = function(identrega) {
	  var filtro = "transaccion=reporte3&identrega=" + identrega; 
	  enviar("Dreporte.php", filtro, setReporteREntrega); 
   }   
     
   
   var setReporteREntrega = function(resultado) {	
...
function validarFecha(value){  
 ...
 var closeVentanaBienvenida = function(id) {
