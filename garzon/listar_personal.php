<?php
    ...
    if (isset($_GET['idpersonal']) && $_GET['idpersonal'] != "") {
        $sql = "update personalapoyo set estado=0 where idpersonalapoyo=$_GET[idpersonal]";	 
        $db->consulta($sql);
...
<div id="modal_mensajes" class="modal_mensajes">
 ...
 <div class="contendedor">
   ...
   <div class="contenedorMenu">
    ...
    <td width="79%">
      <div class="menu2">
       ...
       <form id="formulario" name="formulario" method="get" action="listar_personal.php">
       <?php
  ...
  <tr>
    ...
    <td width="16%"><input type="text"  name="filtro" id="filtro" class="caja_busqueda" value="<?php echo $_GET['filtro'];?>"/></td>
    <td width="13%">
    <select id="campo" name="campo" class="combo">
      <?php
		 $selec = $_GET['campo']; 
		 $tipo = array("idpersonalapoyo", "nombre", "cargo");
		 $texto = array("Nº", "Nombre", "Cargo");
