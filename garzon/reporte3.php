  ...
  <tr>
    <td colspan="6" align="right">
      <table width="80%" border="0" align="center" cellspacing="1">
       ...
       combinacion c where dc.idcombinacion=c.idcombinacion and dc.idatencion=a.idatencion and a.idusuariorestaurante=$idusuario and       credito=0 and  dc.estado=1 and date(a.fecha)='$fechaReporte';";
  ...
  <tr>
    <td colspan="5" align="right"><table width="80%" border="0" align="center">
      ...
      <?php
       ...
       combinacion c where dc.idcombinacion=c.idcombinacion and dc.idatencion=a.idatencion and a.idusuariorestaurante=$idusuario and dc.estado=0 and date(a.fecha)='$fechaReporte';";
   $producto = $db->consulta($sql);
   $total = 0;
   while($data = mysql_fetch_array($producto)){
	  $totalU = $data['cantidad'] * $data['precio'];
