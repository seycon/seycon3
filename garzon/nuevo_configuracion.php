...
<body>
 <div class="contendedor">
  ...
  <tr>
    ...
    <td align="center"><input type="checkbox" name="impresiontv" id="impresiontv" 
	<?php if ($valores['impresiontv']) echo ' checked ';?>
     onclick="setValorCheck(this.id)" value="<?php if (isset($valores['impresiontv'])) echo $valores['impresiontv']; else '0';?>"/></td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    <td align="right" class="letra">Imprimir Cierre de Mesa:</td>
    <td>&nbsp;</td>
    <td align="center"><input type="checkbox" name="impresionCM" id="impresionCM" 
	<?php if ($valores['impresioncm']) echo ' checked ';?>
     onclick="setValorCheck(this.id)" value="<?php if (isset($valores['impresioncm'])) echo $valores['impresioncm']; else '0';?>"/></td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    <td align="right" class="letra">Fecha Venta:</td>
    <td>&nbsp;</td>
    <td align="center"><input type="checkbox" name="impresionFV" id="impresionFV" 
	<?php if ($valores['impresionfv']) echo ' checked ';?>
     onclick="setValorCheck(this.id)" value="<?php if (isset($valores['impresionfv'])) echo $valores['impresionfv']; else '0';?>"/></td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  </tr>  
</table>
