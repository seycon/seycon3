<?php
    ...
    if (isset($_POST['transaccion'])) {
	    ...
	    if($_POST['transaccion'] == "insertar"){			
	        ...
	        $dias = "$_POST[domingo]-$_POST[lunes]-$_POST[martes]-$_POST[miercoles]-$_POST[jueves]-
			$_POST[viernes]-$_POST[sabado]";  
            ...
            $dias = "$_POST[domingo]-$_POST[lunes]-$_POST[martes]-$_POST[miercoles]-$_POST[jueves]-$_POST[viernes]-$_POST[sabado]";  
