...
<?php
  ...
  $fileAcceso = $db->privilegiosFile($estructura['Ventas'],'Ruta de Visita','listar_rutavisita.php','nuevo_rutavisita.php');
...
function eliminarTransaccion(){
  location.href = "anular_registro.php?idrutavisita="+$$("idDelete").value+"&tabla=rutavisita&menu=1";
}
...
var openMensaje = function(codigo){
	...
	$$("modal_contenido").innerHTML = '¿Desea anular esta Ruta de Visita?';
...
<form name="listado" id="listado" method='get' action='listar_rutavisita.php' enctype='multipart/form-data'>
      ...
      <div class="listadoCombo2">
          <div class="borde1Listar"> </div>
            <select id="campo" name="campo" class="borde2Combo1">
              <?php
					echo "<option value=r.idrutavisita>Nº</option>";
...
<?php
	...
	$sql = "select r.idrutavisita,r.fecha,left(concat(t.nombre,' ',t.apellido),20)as 'nombre' 
	from rutavisita r,trabajador t,usuario u where r.idusuario=u.idusuario and 
	u.idtrabajador=t.idtrabajador  ".$condicion." order by r.idrutavisita desc";
...
if ($fileAcceso['Modificar'] == "Si"){ 
	echo "<td><div align='center'><a href='nuevo_rutavisita.php?idrutavisita=".$id."&sw=1#t1' onclick='return modificar(this)'> <img src='css/images/edit.gif' title='Modificar' alt='editar' border='0' /><br /></a></div></td>";
	}else{
