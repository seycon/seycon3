...
var viewreporte_estado = function(){            
  window.open('cuentaporcobrar/reporte_estadocuentacobrar.php?iddeudor='+$$("idpersonarecibida").value
  + '&tipo=' +$$("receptor").value+ "&fecha=" + $$("fecha2").value,'target:_blank');		
}

var viewreporte_resumen = function() {
    window.open('cuentaporcobrar/reporte_resumenporcobrar.php?tipodeudor='+$$("tipodeudor").value
...
<table cellpadding='0' cellspacing='0' width='99%' align="center" class="contemHeaderTop">
  <tr class='cabeceraInicialListar'> 
    <td height="92" colspan='2' valign="middle">&nbsp;&nbsp; <div class="titleFromReport">
     Reportes de Cuentas por Cobrar</div>
    </td>
<td></td>
<td colspan="3" align='right'>
  ...
  <tr>
    ...
    <td><select name="receptor" id="receptor"  onchange="limpiarDeudor()" 
  ...
  <tr>
    ...
    <td colspan="2">
      <input type="button" name="aceptar" id="aceptar" value="Realizar Reporte"
       onclick="viewreporte_estado();"  class="botonNegro" style="width:110px;"/>
      </td>
  </tr>
</table>                  
   </div>
